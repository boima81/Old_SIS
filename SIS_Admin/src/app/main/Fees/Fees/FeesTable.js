...
import {
  getPaymentReceipts,
  selectPaymentReceiptsData,
} from "../../Finance/store/paymentReceiptsSlice";
// import {
//   getRegistrationFees,
...
function FeesTable() {
  ...
  const paymentReceipts = useSelector(selectPaymentReceiptsData);
  ...
  useEffect(() => {
    setLoading(true);
    dispatch(getPaymentReceipts()).then(() => setLoading(false));
  }, [dispatch]);
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell
                        ...
                        scope="row"
                      >
                        {n?.registration?.semesterId?.name}
                      </TableCell>
