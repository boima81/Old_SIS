      ...
      <FuseScrollbars className="grow overflow-x-auto">
        <div className="flex justify-between m-10 items-center">
          <div className="flex gap-10 flex-wrap w-10/12">
            <div className="w-1/4">
              <MainSelect options={[]} label="Select Course" />
            </div>
            <div className="w-1/4">
              <MainSelect options={[]} label="Select Semester" />
            </div>
            <div className="w-1/4">
              <MainSelect options={[]} label="Select Program" />
            </div>
            <div className="w-1/4">
              <MainSelect options={[]} label="Registration State" />
            </div>
            <div className="w-1/4">
              <MainSelect options={[]} label="Select gender" />
            </div>
          </div>
          <Button
            // className="my-32"
...
export default withRouter(RegistrationReport);
