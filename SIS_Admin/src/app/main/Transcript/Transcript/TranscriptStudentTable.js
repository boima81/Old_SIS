...
import TranscriptStudentTableHead from "./TranscriptStudentTableHead";
// import {
//   selectApplications,
//   updateApplicationStatus,
// } from "../store/feesSlice";
const BackendUrl = process.env.REACT_APP_BACKEND_URL;
function TranscriptStudentTable({
  data,
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell
                      ...
                      scope="row"
                    >
                      {dateFormate(n?.registration_date)}
                    </TableCell>
                    <TableCell
                      className="p-4 md:p-16"
                      component="th"
                    ...
                    >
                      ...
                      >
                        <Button
                          ...
                          onClick={() =>
                            getGenerateTableData({ userId: n?.user })
                          }
                        >
                          Generate
                        </Button>
...
export default withRouter(TranscriptStudentTable);
