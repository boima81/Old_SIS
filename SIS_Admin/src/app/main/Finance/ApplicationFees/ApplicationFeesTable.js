...
import ApplicationFeesTableHead from "./ApplicationFeesTableHead";
import { getPayments, selectPaymentsData } from "../store/paymentsSlice";
...
function ApplicationFeesTable(props) {
          ...
          <div className="flex justify-end m-20 items-center">
            <DownloadButton
              data={data?.map((dt) => {
                return {
                  ...dt,
                  amountCSV: `${dt?.amount || 0}`,
                };
              })}
              headers={[
                {
                  label: "Student Name",
                  key: "application.userInfo.userInformationId.displayName",
                },
                {
              ...
              fileName="ApplicationFeesReport.csv"
            />
          </div>
        ) : null}
        <Table stickyHeader className="min-w-xl" aria-labelledby="tableTitle">
          <ApplicationFeesTableHead
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className="p-4 md:p-16" component="th" scope="row">
                      {n?.application?.userInfo?.userInformationId?.displayName}
                    </TableCell>
                    <TableCell className="p-4 md:p-16" component="th" scope="row">
                    ...
                    {n?.application?.receiptFile ? (
                      <TableCell className="p-4 md:p-16 truncate" component="th" scope="row">
                        <a
                          href={n?.application?.receiptFile || ""}
                          target="_blank"
                          rel="noreferrer"
                        >
                          Receipt File
...
export default withRouter(ApplicationFeesTable);
