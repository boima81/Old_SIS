...
function PaymentTermsHeader({ showSearchAddButton = true, isHomePage = true }) {
  ...
  return (
    <div className="flex flex-col sm:flex-row space-y-16 sm:space-y-0 flex-1 w-full items-center justify-between py-32 px-24 md:px-32">
      <Typography
        ...
        to={`${!isHomePage && "/finance/payment-terms"}`}
      >
        {!isHomePage && (
          <FuseSvgIcon size={20}>
            {theme.direction === "ltr"
...
export default PaymentTermsHeader;
