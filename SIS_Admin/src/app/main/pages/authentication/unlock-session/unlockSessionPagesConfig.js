...
const ModernReversedUnlockSessionPage = lazy(() =>
  import("./ModernReversedUnlockSessionPage")
);
const SplitScreenUnlockSessionPage = lazy(() =>
  import("./SplitScreenUnlockSessionPage")
);
const SplitScreenReversedUnlockSessionPage = lazy(() =>
  import("./SplitScreenReversedUnlockSessionPage")
);
const FullScreenUnlockSessionPage = lazy(() =>
  import("./FullScreenUnlockSessionPage")
);
