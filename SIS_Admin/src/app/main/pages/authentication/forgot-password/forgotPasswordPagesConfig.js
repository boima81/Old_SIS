...
const ModernForgotPasswordPage = lazy(() =>
  import("./ModernForgotPasswordPage")
);
const ModernReversedForgotPasswordPage = lazy(() =>
  import("./ModernReversedForgotPasswordPage")
);
const SplitScreenForgotPasswordPage = lazy(() =>
  import("./SplitScreenForgotPasswordPage")
);
const SplitScreenReversedForgotPasswordPage = lazy(() =>
  import("./SplitScreenReversedForgotPasswordPage")
);
const FullScreenForgotPasswordPage = lazy(() =>
  import("./FullScreenForgotPasswordPage")
);
