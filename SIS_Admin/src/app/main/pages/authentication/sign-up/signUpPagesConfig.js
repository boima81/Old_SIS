...
const ModernReversedSignUpPage = lazy(() =>
  import("./ModernReversedSignUpPage")
);
const SplitScreenSignUpPage = lazy(() => import("./SplitScreenSignUpPage"));
const SplitScreenReversedSignUpPage = lazy(() =>
  import("./SplitScreenReversedSignUpPage")
);
const FullScreenSignUpPage = lazy(() => import("./FullScreenSignUpPage"));
const FullScreenReversedSignUpPage = lazy(() =>
  import("./FullScreenReversedSignUpPage")
);
