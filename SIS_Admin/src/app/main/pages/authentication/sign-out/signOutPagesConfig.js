...
const ModernReversedSignOutPage = lazy(() =>
  import("./ModernReversedSignOutPage")
);
const SplitScreenSignOutPage = lazy(() => import("./SplitScreenSignOutPage"));
const SplitScreenReversedSignOutPage = lazy(() =>
  import("./SplitScreenReversedSignOutPage")
);
const FullScreenSignOutPage = lazy(() => import("./FullScreenSignOutPage"));
const FullScreenReversedSignOutPage = lazy(() =>
  import("./FullScreenReversedSignOutPage")
);
