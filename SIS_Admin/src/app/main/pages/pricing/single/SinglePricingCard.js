...
import { currencyName } from "src/app/main/dashboards/Shared/utils";
    ...
    <Paper className="flex flex-col lg:flex-row max-w-sm lg:max-w-xl overflow-hidden">
      <div className="p-24 sm:p-32 lg:p-40">
        ...
        <Typography className="mt-8 leading-relaxed" color="text.secondary">
          Learn from like-minded individuals which are eager to make a living
          building stuff on the web. Pay once and get lifetime access to the
          community.
        </Typography>
      ...
      >
        ...
        <Button
          variant="contained"
          color="secondary"
          className="w-full mt-32 lg:mt-auto"
        >
          Get Started
        </Button>
      </Box>
