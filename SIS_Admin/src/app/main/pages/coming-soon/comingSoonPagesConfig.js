...
const ModernReversedComingSoonPage = lazy(() =>
  import("./ModernReversedComingSoonPage")
);
const SplitScreenComingSoonPage = lazy(() =>
  import("./SplitScreenComingSoonPage")
);
const SplitScreenReversedComingSoonPage = lazy(() =>
  import("./SplitScreenReversedComingSoonPage")
);
const FullScreenComingSoonPage = lazy(() =>
  import("./FullScreenComingSoonPage")
);
const FullScreenReversedComingSoonPage = lazy(() =>
  import("./FullScreenReversedComingSoonPage")
);
