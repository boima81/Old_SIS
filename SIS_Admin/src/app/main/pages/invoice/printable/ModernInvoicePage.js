            ...
            <div className="grid grid-cols-12 gap-x-4 mt-16">
              ...
              <div className="col-span-8">
                ...
                <Typography className="mt-8 text-md" color="text.secondary">
                  Prototyping of the application's general workflow and the
                  detailed design of its 72 screens as a working prototype.
                </Typography>
              </div>
              ...
              <div className="col-span-8">
                ...
                <Typography className="mt-8 text-md" color="text.secondary">
                  ...
                  appropriate tools and registering it to major application
                  stores.
                </Typography>
              </div>
              ...
              <div className="col-span-8">
                ...
                <Typography className="mt-8 text-md" color="text.secondary">
                  Development of the detailed documentation, preparing guides
                  and instructional videos and extensive training of 2 people.
                </Typography>
              </div>
