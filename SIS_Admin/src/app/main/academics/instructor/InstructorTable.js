...
function InstructorTable(props) {
  ...
  const instructors = useSelector(selectInstructorData);
  ...
  useEffect(() => {
    setLoading(true);
    dispatch(getInstructors()).then((action) => {
      console.log({ action });
      setLoading(false);
  ...
  function handleClick(item) {
    props.navigate(`/academics/instructors/${item.id}`);
  }
...
export default withRouter(InstructorTable);
