...
module.exports = {
  ...
  // "redis://default:InUf1ePACVnopZr4EVsa@containers-us-west-42.railway.app:6300",
  mail: {
  ...
  datastores: {
    ...
    default: {
      ...
      url: "postgresql://adminuser:Admin@1234@localhost:5432/school_management",
      // "postgresql://postgres:Tpdz2ssyyGXKhqYhYPpQ@containers-us-west-141.railway.app:6740/railway",
      //
      //
      //--------------------------------------------------------------------------
   ...
   ***************************************************************************/
  custom: {
    // Change the name of production url
    frontendUrl: "https://avcstudentportal.com",
    // "staging--scool-management.netlify.app",
    // "https://scool-management.netlify.app",

    baseUrl: "https://api.avcstudentportal.com",
    // "https://school-management-api-6i79.onrender.com",
    // "https://scool-management.netlify.app",

    fLWSECRETHASH: "test",
    FLW_PUBLIC_KEY: "FLWPUBK_TEST-9bc850afe048894442ec40aa216d2b08-X",
    FLW_SECRET_KEY: "FLWSECK_TEST-5382dbe4897a52e7c9359dd22cd6ed10-X",

    // "https://api.avcstudentportal.com",
    internalEmailAddress: "support@example.com",
    uploadFolderName: "production"
